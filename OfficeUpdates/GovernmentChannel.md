...
- **將共用內容快顯到個別的視窗中。：** 使用者可以在不同的視窗中快顯共用會議內容。

- **Microsoft Teams：在 Windows 上的 Teams 會議室上共用內容體驗改進：** windows 上的Teams 會議室更新使用者介面，以在會議中共用 HDMI 和內容相機。 新的體驗可提供更好的工作完成，並為會議室內的使用者提供更清楚的體驗，確保使用者可以輕鬆地在會議中共用內容。
...
### <a name="dod-customers-gcc-h-customers"></a>DoD 客戶：### GCC-H 客戶：
