...
- 
  **政府客戶：將敏感度標籤套用至您的文件和電子郵件：** 敏感度標籤功能目前可供 GCC 和 GCC-H 環境中的客戶取得。(深入了解 - https://docs.microsoft.com/en-us/microsoft-365/compliance/sensitivity-labels)。
