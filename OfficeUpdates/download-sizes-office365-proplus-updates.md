...
> [!NOTE]
> 使用 Office 時如需問題協助，建議將問題張貼在 [Microsoft Answers 論壇](https://answers.microsoft.com/)或 [Tech 社群](https://techcommunity.microsoft.com/)，也可以連絡[支援中心](https://support.microsoft.com/contactus)。
