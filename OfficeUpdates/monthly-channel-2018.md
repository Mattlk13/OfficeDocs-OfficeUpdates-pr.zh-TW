---
title: "2018 年每月通道版本的版本資訊" ms.author: andrewmo author: andymosten manager: andrewmo ms.date:10/3/2018 ms.audience: ITPro ms.topic: reference ms.service: o365-proplus-itpro localization_priority: Critical ms.collection: RelNotes_ProPlus description: "為 IT 專業人員提供 2018 年 Office 365 專業增強版每月通道版本的版本資訊"
---
...
這些版本資訊提供 2018 年 Office 365 專業增強版每月通道更新中所包含的全新功能、安全性更新和非安全性更新等相關資訊。
 ...
 > [!NOTE]
> - 以下內容也會提供 Visio Pro for Office 365 及 Project Online Desktop Client 新功能、 安全性更新及非安全性更新等相關資訊。
> - 此資訊也適用於 Office 365 商務版。Office 365 商務版是一些 Office 365 方案附隨的 Office 版本 (例如，商務進階版)。
...
- **探索更多關於您的資料** Office 365 應用程式結合了人工智慧 (AI)，可協助您達成最佳的工作成果。 構想窗格使用 AI 提供極具智慧的實用建議，可以幫助您節省時間並強化您的內容。[深入了解](https://support.office.com/article/3223aab8-f543-4fda-85ed-76bb0295ffc4)
- **呼叫所有的 Get & Transform 粉絲** 如果您經常使用 Get & Transform，改善後的範例欄位功能一定會讓您滿意。 而且，許多連接器也已經獲得改善。 [深入了解](https://support.office.com/article/ed01ec34-679d-48e7-ba49-bb14c7908f9e)
...
- **快來看看我們即將推出什麼產品** 在這些產品發表之前，來試試全新的使用者體驗，並讓我們知道您的想法。 [深入了解](https://support.office.com/article/d4b7db49-b4e0-4f98-a0dc-156952e551e2)
- **查看安全連結背後的 URL** 安全連結可以保護您免於受到電子郵件中惡意 URL 的威脅，但安全連結也會隱藏原始的 URL。 現在，您只須將滑鼠停留在 URL 上就能查看原始的 URL，即使是在受到安全連結保護的連結中也是一樣。
- **取得搜尋拼字建議的結果** 執行搜尋之後，Outlook 會提供建議的搜尋結果和拼字校正。
- **您的功能區圖示已有新外觀** 不用擔心，所有功能的運作方式都和以前一樣。​ 此外，它們更適合顯示在各種尺寸的畫面上。 [深入了解](https://support.office.com/article/c6bc4cd8-d151-41d3-8276-fc7c9975eb79)

### <a name="powerpoint-feature-updates"></a>PowerPoint：功能更新
- **觀看投影片播放運作** 插入動畫 3D 圖形來觀看心跳、行星軌道和霸王龍在螢幕上橫衝直撞 。  [深入了解](https://support.office.com/article/ad6ade3a-be41-4cf1-b761-46dcfd14dfc8)
- **新增校訂工具** 編輯文字不再有任何壓力。 PowerPoint 現已提供文法與撰寫的建議。 [深入了解](https://support.office.com/article/91ecbe1b-d021-4e9e-a82e-abc4cd7163d7)
- **您的功能區圖示已有新外觀** 不用擔心，所有功能的運作方式都和以前一樣。​ 此外，它們更適合顯示在各種尺寸的畫面上。 [深入了解](https://support.office.com/article/c6bc4cd8-d151-41d3-8276-fc7c9975eb79)

### <a name="word-feature-updates"></a>Word：功能更新
- **透過\@提及項目引起對方的注意** 在評論中使用 @提及讓同事知道您需要他們輸入資料。 [深入了解](https://support.office.com/article/644bf689-31a0-4977-a4fb-afe01820c1fd)
- **您的功能區圖示已有新外觀** 不用擔心，所有功能的運作方式都和以前一樣。​ 此外，它們更適合顯示在各種尺寸的畫面上。 [深入了解](https://support.office.com/article/c6bc4cd8-d151-41d3-8276-fc7c9975eb79)
...
### <a name="access-feature-updates"></a>Access：功能更新
 - **重新整理、 重新連結，或移除已連結的資料表** 已更新之連結的資料表管理員是管理所有資料來源及連結資料表的所在位置。 [深入了解](https://support.office.com/article/1d9346d6-953d-4f85-a9ce-4caec2262797)

### <a name="outlook-feature-updates"></a>Outlook：功能更新
 - **關閉會議轉寄功能** 防止出席者將您的會議轉寄給其他人。 您只須移動到功能區，並按一下回應選項即可。 [深入了解](https://support.office.com/article/5C9877BC-AB91-4A7C-99FB-B0B68D7EA94F)
 
### <a name="visio-feature-updates"></a>Visio：功能更新
 - **在下一個圖表中享受使用全新圖示帶來的樂趣** 從 26 個全新的圖示樣板中，挑選可用於分析、 藝術、 慶祝、 笑臉和運動的圖示。 
 - **使用 Visio 圖形建立一份 Word 文件** 自動在 Word 文件中加入圖表內容 (包括圖形與中繼資料)， 接著自訂文件來建立程序指導方針及操作手冊。 [深入了解](https://support.office.com/article/48073f4f-c6d4-4cc0-b9ae-3cb65e2ee158)
 - **Visio 和 Power BI：兩者搭配，成效更大** 只要點選幾下，就能把您的 Visio 圖表轉換成互動式的 Power BI 視覺效果。 [深入了解](https://support.office.com/article/4f09be62-f436-45c2-93b0-4a0f66b1f5a7)

 ### <a name="project-feature-updates"></a>Project：功能更新
 - **在工作面板卡上顯示更多資訊** 當標題本身無法讓人了解事情內容時，您可以自訂您的工作面板卡來顯示最重要的詳細資訊。 [深入了解](https://support.office.com/article/1b9b44d7-fd8e-4b3b-ab94-2b97deb9945b)

### <a name="excel-non-security-updates"></a>Excel：非安全性更新
-  修正了 Excel 中的問題：使用者即使執行貼上這類的作業時，在複製原本選取的儲存格範圍後所顯示的點線標記並不會消失，而是繼續保留在剪貼簿中。 

### <a name="outlook-non-security-updates"></a>Outlook：非安全性更新
 - 針對部分設定了多個 Exchange 帳戶的使用者解決了搜索結果清單中缺少了「點選以深入查看...」連結的問題。

### <a name="office-suite-non-security-updates"></a>Office 套件：非安全性更新
 - 修正了在某些情況下安裝更時需時過久的問題。
 
### <a name="lync-non-security-updates"></a>Lync：非安全性更新
 - 修正了 IM 訊息中表情符號無法顯示的問題。 
...
### <a name="outlook-feature-updates"></a>Outlook：功能更新
- **Outlook 增益集警告：** 有時 Outlook COM 增益集會發生問題，導致其他 Outlook 功能變慢。這些問題可能與以下事件有關，比如說在 Outlook 資料夾之間進行切換、收到新的電子郵件、開啟行事曆項目等等。當這類問題發生時，Outlook 會在通知列中顯示警告。
- **從 Outlook 提醒對話方塊加入小組會議：** 當 Outlook 提醒使用者將有即將來臨的會議時，如果即將來臨的會議是小組的線上會議，則它會顯示 [線上加入] 按鈕。這個動作與從 Outlook [提醒] 對話方塊加入商務用 Skype 會議的體驗類似。
...
### <a name="word-feature-updates"></a>Word：功能更新
 - **使用 IRM 追蹤修訂：** 現在您無須「完全控制」的使用權限，也能在 Word 中對受 IRM 保護的文件使用「追蹤修訂」功能。

### <a name="office-suite-non-security-updates"></a>Office 套件：非安全性更新
 - 修正了一系列的問題，這些問題會導致部分使用者無法開啟受 IRM 保護的文件和電子郵件 (由其他組織中的人員與其共用)。
...
### <a name="excel-feature-updates"></a>Excel：功能更新
 - **改善儲存格及公式列的編輯方式：** 您現在可以使用 CTRL + A 來選取儲存格或公式列中的文字。 改善對 Emoji 及其他複雜字元的支援功能。[深入了解](https://support.office.com/article/1798d9d5-842a-42b8-9c99-9b7213f0040f)
 - **改善 SVG 支援：** 您可以插入已套用了篩選的 SVG。[深入了解](https://support.office.com/article/e2459f17-3996-4795-996e-b9a13486fa79)

### <a name="outlook-feature-updates"></a>Outlook：功能更新
 - **週期性預設：** 在 [週期性約會] 的對話方塊中 (「定期範圍」下)，「結束日期」是預設的設定 (而非「沒有結束日期」) 及列出的第一個設定，且預設的結束日期已經設定。
 - **協助工具檢查程式改善︰** 協助工具檢查程式已更新對國際標準與建議的支援，以使您的訊息更易於存取。 [深入了解](https://support.office.com/article/a16f6de0-2f39-4a2b-8bd8-5ad801426c7f)

### <a name="powerpoint-feature-updates"></a>PowerPoint：功能更新
 - **改善 SVG 支援：** 您可以插入已套用了篩選的 SVG。[深入了解](https://support.office.com/article/e2459f17-3996-4795-996e-b9a13486fa79)
 - **用手寫筆為投影片撰寫標題：** 使用手寫筆輸入標題，並觀看 PowerPoint 將它轉換成文字。[深入了解](https://support.office.com/article/0740dec3-6291-4c1f-8baa-011d18449919)


### <a name="project-feature-updates"></a>Project：功能更新
 - **使用最近的儲存位置保持有條不紊：** Project 會持續保存您已儲存其他專案的位置清單。當您準備好要儲存專案時，只需選擇其中一個您最近的儲存位置，就能繼續進行您一天的工作。
 - **管理短期衝刺的全新方法：** 採取敏捷方式來使用工作面板。隨著專案的進行，您可以移至 [管理短期衝刺] 來新增或移除短期衝刺。
...
### <a name="word-feature-updates"></a>Word：功能更新
 - **改善的 SVG 支援：** 您可以插入已套用了篩選的 SVG 。[深入了解](https://support.office.com/article/e2459f17-3996-4795-996e-b9a13486fa79)
...
- 修正了當您在透過主要專案內容使用子專案時，系統阻止您儲存子專案的問題。

## <a name="version-1805-may-24"></a>版本 1805：5 月 24 日
*版本 1805 (組建 9330.2087)*

### <a name="outlook-non-security-updates"></a>Outlook 非安全性更新
 - 修正了 Outlook 在使用 iCloud 增益集時會當機的問題。
...
### <a name="access-feature-updates"></a>Access：功能更新
 - **使用新圖表來視覺化方式呈現資料：** 從 11 個圖表中選擇，並將其中一個新增至您的表單和報告，更有效地以視覺化方式呈現資料並做出明智Translated的決策。[深入了解](https://support.office.com/article/1a463106-65d0-4dbb-9d66-4ecb737ea7f7)

### <a name="excel-feature-updates"></a>Excel：功能更新
 - **在編輯時與共同作者交談：** 藉由與共同作者聊天，無需離開 Excel 就可更有效率地共同作業。 請注意，這項功能在某些區域無法使用。[深入了解](https://support.office.com/article/1ecc6c7f-0b02-4baa-b9d9-c9d67023bedd)
...
### <a name="project-non-security-updates"></a>Project：非安全性更新
 - 修正了 Project 第一次在 Project Web 應用程式中儲存專案時可能當機的問題。


### <a name="visio-feature-updates"></a>Visio：功能更新
 - **入門圖表：** 組織圖、腦力激盪和 SDL 範本有新的入門圖表可讓您快速啟動和執行。

### <a name="word-feature-updates"></a>Word：功能更新
 - **在在編輯時與共同作者交談：** 藉由與共同作者聊天，即可更有效率地共同作業而不需要離開 Word。[深入了解](https://support.office.com/article/1ecc6c7f-0b02-4baa-b9d9-c9d67023bedd)
 - **免操作輸入：** 使用您的聲音直接以說話方式建立簡報。不需手動輸入。[ 深入了解](https://support.office.com/article/d4fd296e-8f15-4168-afec-1f95b13a6408)
...
### <a name="office-suite-non-security-updates"></a>Office 套件：非安全性更新
- 修正了開啟應用程式時使用者可能會看到以安全模式啟動的訊息，接著應用程式無法開啟的問題。
...
-   **絕不錯過任何提醒：** 將提醒設定為在您正在工作的視窗上彈出。 如果沒有設定的話，Outlook 會在工作列中閃爍引起您的注意。[深入了解 ](https://support.office.com/article/7a992377-ca93-4ddd-a711-851ef3597925)
-   **將刪除的郵件標示為已讀取：** 您現在可以將任何已刪除的郵件標示為已讀取。請移至 [檔案] \> [選項] \> [郵件] \> [其他] 來選擇使用這項功能。
-   **加密選項：** Office 365 郵件加密的使用者可以將郵件加密並傳送給組織內外的任何人。建立郵件時，加密選項會出現在 [選項] \> [權限] 底下。 [深入了解](https://aka.ms/omeoverview)
...
-   **短期衝刺瀏覽：** 從某個短期衝刺視圖切換為另一個視圖，並快速地在短期衝刺之間移動工作。
...
-   修正了多個使用者在相同簡報上共同撰寫時會導致投影母片不正確重複顯示的問題。
...
-   修正了按一下超連結後可能會導致 Excel 當機的問題。
-   修正了使用 cube 函數會導致 Excel 當機的問題。

### <a name="onedrive-for-business-non-security-updates"></a>商務版 OneDrive：非安全性更新
-   修正了商務用 OneDrive (Groove.exe) 在 [工作管理員] 中長時間耗用相當於一個 CPU 核心 CPU (例如，4 核心 CPU 的 25%) 的問題。

### <a name="outlook-feature-updates"></a>Outlook：功能更新
-   **密件副本 (Bcc) 警告：** 如果您對先前使用密件副本的郵件選擇 [全部回覆]，將會顯示警告訊息。
-   **更聰明的 [收件者：] 行：** 當您按一下 [收件者：] 來撰寫郵件時，我們會建議您可能要選擇的收件者。此外，您還可以看到收件者相片，讓您知道要傳送的對象是否正確。 
...
### <a name="excel-security-updates"></a>Excel：安全性更新
-   [CVE-2018-0907](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-0907)：Microsoft Office Excel 安全性功能略過漏洞
...
-   **輕鬆地排序您的電子郵件：** 由於您的意見反應，我們已針對不使用 [焦點收件匣] 的使用者，重新加入了郵件清單上方的排序功能和 [未讀取] 篩選器。

### <a name="project-non-security-updates"></a>Project：非安全性更新
-   修正了在工作階段中設定多個基準會使得\_DATE 值都設為相同值的問題。

### <a name="skype-for-business-non-security-updates"></a>商務用 Skype：非安全性更新
-   修正了即使 UseLocationForE911Only 設定為 true 時也會填入位置的問題。
-   修正了使用名冊中的「使用會議中心呼叫」選項來邀請使用者時商務用 Skype 會當機的問題。
-   修正了建立商務用 Skype 會議時在終端機伺服器上執行的 Outlook 會凍結的問題。
-   將 EnableRestoreOAuthUsedKeyWhenUsingCachedWebTicket 的預設值變更為 TRUE。

### <a name="visio-feature-updates"></a>Visio：功能更新
-   **內建資料庫模型圖表：** 使用新的資料庫模型圖表範本，將您的資料庫精確地建模為 Visio 圖表。不需要使用增益集。
-   **更多商用圖表的樣板：** 使用新式圖形，以文氏圖表來比較和對比資料，或是繪製循環、矩陣或金字塔圖表來表達您的想法。
...
### <a name="outlook-security-updates"></a>Outlook：安全性更新
-   [CVE-2018-0850](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-0850)：Microsoft Outlook 提高權限漏洞
...
### <a name="excel-non-security-updates"></a>Excel：非安全性更新
-   修正了在使用日文、中文或韓文編輯語言時，如果嘗試在 [首頁] 索引標籤上選取新字型或編輯時 Excel 可能會凍結的問題。
...
### <a name="project-non-security-updates"></a>Project：非安全性更新
-   修正了將實際工時從 [儲存為共用] 工作階段中移除之後 [實際工時] 仍顯示在報表中的問題。
-   修正了在德文版中進行排程時使用 [週] 日期格式會傳回錯誤的問題。
-   修正了在編輯 [排程網頁組件] 的完成日期時工作保持為每天 8 小時，而不是隨著時間分配的問題。
-   修正了在非預期的位置繪製「進度點形狀」的問題。

### <a name="skype-for-business-non-security-updates"></a>商務用 Skype：非安全性更新
-   修正了當會議處於全螢幕模式時 [其他選項] 和 [邀請其他人] 按鈕會隱藏的問題。
-   修正了當您想要加入會議時 P2P 音訊撥號視窗或電話會議視窗會變成透明的問題。
-   修正了即將開始的 Skype 會議未顯示在 [會議] 索引標籤上的問題。
-   修正了當商務用 Skype 被設定為無音訊加入會議，新增音訊至會議時不會將音訊新增至現有的會議，而是向使用者本身啟動新 P2P 撥號的問題。
-   修正了當使用者按下 Outlook 會議邀請的 [加入 Skype 會議] 連結時會收到 [找不到此 Skype 會議] 錯誤訊息的問題。
...
### <a name="excel-non-security-updates"></a>Excel：非安全性更新
-   修正了當 Excel 最小化時開啟活頁簿時捲軸會遺失的問題。

### <a name="outlook-non-security-updates"></a>Outlook：非安全性更新
-   修正了當搜尋範圍限定為 [所有信箱] 時搜尋會失敗並顯示 [找不到相符項目] 的問題。
...
### <a name="excel-non-security-updates"></a>Excel：非安全性更新
-   修正了在 [檔案總管] 中的檔案名稱上按兩下以開啟多個活頁簿時活頁簿參照會失敗的問題。

### <a name="outlook-feature-updates"></a>Outlook：功能更新
-   **將 SVG 圖示轉換成圖形：** 將所有 SVG 圖片和圖示轉換成 Office 圖形，可讓您變更其色彩、大小或材質。
-   **Office 365 群組的改善︰** 您可以在群組訊息上按兩下以開啟其個別視窗。這可讓您更加容易閱讀和回覆群組對話。
...
-   當 ChatDefaultClient 和 CallDefaultClient 設定為 Teams 時，通知使用者來電與交談正在傳送至 Teams。
...
-   修正了當 EnableExternalP2PFileTransfer 原則設為 false 時使用者仍可以在會議中附加檔案的問題。

### <a name="visio-feature-updates"></a>Visio：功能更新
-   **使用 Excel 範本匯出至 Visio 圖表：** 搶先使用 Visio 流程表。在其中一個程序圖 Excel 範本中輸入資料，並匯出至 Visio 以自動建立圖表。您將需要 Visio Pro for Office 365。
...
### <a name="excel-non-security-updates"></a>Excel：非安全性更新
-   修正了以程式設計方式建立樞紐分析表後以程式設計方式重新整理會導致 Excel 當機的問題。
-   修正了以程式設計方式呼叫 Workbook.Open() 可能會導致 Excel 當機的問題。

### <a name="powerpoint-non-security-updates"></a>PowerPoint：非安全性更新
-   修正了移除文件屬性和個人資訊會導致儲存至 SharePoint 失敗的問題。

### <a name="project-non-security-updates"></a>Project：非安全性更新
-   修正了 VBA 程式碼從專案中遺失的問題。

> [!NOTE]
> 如果您需要關於使用 Office 的問題協助，建議您將問題張貼在 [Microsoft 解答論壇](https://answers.microsoft.com/)[或 Tech 社群](https://techcommunity.microsoft.com/)，或是連絡[支援支援](https://support.microsoft.com/contactus)。