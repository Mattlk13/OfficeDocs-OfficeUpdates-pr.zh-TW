...
版本資訊包括 2018 年 Office 365 專業增強版的半年通道 (已設定目標) 更新所含全新功能、安全性更新和非安全性更新等相關資訊。
 
> [!NOTE]
> - 下面也會提供 Visio Pro for Office 365 和 Project Online 桌面用戶端的全新功能、安全性更新和非安全性更新等相關資訊。
> - 此資訊也適用於 Office 365 商務版。Office 365 商務版是某些 Office 365 方案 (例如，商務進階版) 隨附的 Office 版本。

 ## <a name="version-1808-september-11"></a>版本 1808：  9 月 11 日
*版本 1808 (組建 10730.20102)*

### <a name="access-feature-updates"></a>Access：功能更新
 - **使用新圖表以視覺化方式呈現資料：** 從 11 個圖表中做出選擇，並將其中一個新增至您的表單和報告，更有效地以視覺化方式呈現資料並進行明智的決策。[深入了解](https://support.office.com/article/1a463106-65d0-4dbb-9d66-4ecb737ea7f7)
...
- ** 改善協助工具檢查程式︰** 協助工具檢查程式已更新其對國際標準與建議的支援，從而使活頁簿存取更加便利。 [深入了解](https://support.office.com/article/a16f6de0-2f39-4a2b-8bd8-5ad801426c7f)
...
-   修正此問題：從原儲存格變更圖表來源資料時會導致 Excel 當機。
-   修正此問題：即使已設定 FullCalcOnLoad 屬性，開啟時也可能不會重新計算。  
...
-   修正此問題：在嘗試與受保護 Workbook 文字檔建立新連線時，收到「Workbook 受到保護，且無法變更」的錯誤訊息。
-   修正此問題：在 Outlook 電子郵件中無法快速列印有 Excel 活頁簿的附件。
-   修正此問題：按一下超連結可能會造成 Excel 當機。
-   修正此問題：使用 cube 函數會造成 Excel 當機。

### <a name="outlook-feature-updates"></a>Outlook：功能更新
 - **改善協助工具檢查程式︰** 協助工具檢查程式已更新對國際標準與建議的支援，從而使您的郵件更易於存取。 [深入了解](https://support.office.com/article/a16f6de0-2f39-4a2b-8bd8-5ad801426c7f)
...
-   修正此問題：在會議中選取 [Skype 通話] 來新增使用者會產生錯誤。
...
-  修正此問題：開啟應用程式時，使用者可能會看到以安全模式啟動的訊息，然後應用程式便無法開啟。
-  修正一些效能問題。
...
-   與 Aries 電話配對且啟用 RedirectClient 時，隱藏新的來電和對話。
