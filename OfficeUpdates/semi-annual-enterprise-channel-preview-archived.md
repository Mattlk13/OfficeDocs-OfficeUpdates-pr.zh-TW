...
> - 從版本 1902 開始，Microsoft Teams 會包含在半年企業通道(預覽版) 的全新安裝中。 將 Teams 更新至版本 1908 或更新版本時，即會將 Teams 新增至半年企業通道 (預覽) 的現有安裝中。 如需詳細資訊，請參閱[使用 Office 365 專業增強版部署 Microsoft Teams](/deployoffice/teams-install)。
