...
若要尋找版本資訊，請 [參閱](https://docs.microsoft.com/zh-TW/OfficeUpdates/current-channel-preview)。 而且您也可以參閱 [Office 測試人員的新增功能](https://insider.office.com/zh-TW/releasenotes/windows/slow)。
